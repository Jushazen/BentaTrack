...
| 4.2 | src/features/refunds/\*\*, src/app/(app)/sales/\*\*, tests/integration/refunds/\*\*, tests/e2e/refunds/\*\* | 4.1 | mechanical | 9 | VERIFIED |
| 5.1 | src/features/reports/\*\*, src/lib/dates.ts, src/app/(app)/reports/\*\*, src/components/charts/\*\*, tests/unit/reports/\*\*, tests/integration/reports/\*\*, tests/e2e/reports/\*\* | 4.2 | judgment | 10 | READY |
