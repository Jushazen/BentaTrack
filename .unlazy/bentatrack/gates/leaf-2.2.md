...
Scope: Username/password login with Auth.js v5 credentials, bcrypt hashes, role-based route protection in src/proxy.ts, and the capability matrix from the PLAN contract.
...
- [ ] G1: credentials: passwords required, hashed, min 8 chars, usernames unique, deactivated users rejected
